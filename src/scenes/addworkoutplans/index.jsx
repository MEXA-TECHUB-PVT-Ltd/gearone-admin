                ...
                {/* <Container>
                    ...
                    <Container>
                        <Grid container spacing={0}>
                            <Grid xs={12} md={6} lg={6} xl={6} p={1} align="" >
                                <Box pt={2} pb={2}>
                                    <Box sx={{ pt: 2, width: "90%", height: "20vh", p: "0.5px", border: "dotted 1px lightgray", float: "", borderRadius: "5px" }} className="image_preview">
                                        {hidelabel ?
                                            null
                                            :
                                            <Grid container spacing={0} pt={5}>
                                                <Grid xs={12} align="">
                                                    <Stack align="">
                                                        <label htmlFor="fileInput" style={{ display: "flex", justifyContent: "center", alignContent: "center", color: "#808080" }}>
                                                            <Stack direction="column" spacing={1}>
                                                                <Upload sx={{ fontSize: "50px", color: "#808080", ml: 10, pb: 1 }} />
                                                                <span style={{ fontFamily: "normal normal normal 16px/26px Arial" }}>Upload Exercise Animation</span>
                                                            </Stack>
                                                        </label>
                                                        <input
                                                            style={{ display: "none" }}
...

                                    {
                                        hidecrossicon ?
                                            <Box sx={{ display: "flex", justifyContent: "right", alignContent: "right" }}>
                                                <Close sx={{ padding: 0.2, backgroundColor: "#FD684A", borderRadius: "50px", color: "#3CC922", mt: -22 }} onClick={() => clearpreviewimage()} />
                                            </Box>
                                            :
                                            null
                                    }
                            ...
                            <Grid xs={12} md={6} lg={6} xl={6} p={1} align="" >
                                <Box pt={2} pb={2}>
                                    <Box sx={{ pt: 2, width: "90%", height: "20vh", p: "0.5px", border: "dotted 1px transparent", float: "", borderRadius: "5px" }} className="image_preview">
                                        {hidelabel ?
                                            null
                                            :
                                            <Grid container spacing={0} pt={5}>
                                                <Grid xs={12} align="">
                                                    <Stack align="">
                                                        <label htmlFor="fileInput" style={{ display: "flex", justifyContent: "center", alignContent: "center", color: "transparent" }}>
                                                            <Stack direction="column" spacing={1}>
                                                                <Upload sx={{ fontSize: "50px", color: "transparent", ml: 10, pb: 1 }} />
                                                                <span style={{ fontFamily: "normal normal normal 16px/26px Arial", color: "transparent" }}>Upload Exercise Animation</span>
                                                            </Stack>
                                                        </label>
                                                        <input
                                                            style={{ display: "none" }}
                            ...
                            <Grid xs={12} align="center">
                                <Button variant="contained" style={btn} >Add</Button>
                            </Grid>
                        </Grid>
                    </Container>
                </Container> */}
